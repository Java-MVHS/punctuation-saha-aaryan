...
{
	public Punctuation() //empty constructor
	{
	...
	public static void main(String[] args)
	{
		String text = " Blood, Sweat, and Tears by Winston Churchill " +
						...
						"Administration. It was the evident wish and wil" +
						" of Parliament and the " +
						"nation that this should be conceived on the bro" +
						"adest possible basis and that it should " +
						"include all parties, both those who supported " +
						"the late Government and also the parties " +
						"of the Opposition. " +
						"I have completed the most important part of" +
						" this task. A War Cabinet has " +
						"been formed of five Members, representing, " +
						"with the Liberal Opposition, the unity of the " +
						"nation. The three party Leaders have agreed to" +
						" serve, either in the War Cabinet or in " +
						"high executive office. The three Fighting Serv" +
						"ices have been filled. It was necessary " +
	...
	public void getPunctuationWords(String text)
	{
			...
			while(i < text.length())
			{
				if(text.charAt(i) == ' ')
						start = i;
				else if(checkForPunctuation(text.charAt(i)))
					{
					    printWords(text.substring(start, i+1));
					}
